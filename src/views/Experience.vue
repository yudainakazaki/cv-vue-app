    ...
    >
      ...
      <template #logo>
        <a href="https://payaut.com/" target="_blank">
          <img src="src/images/payaut.jpeg" style="height: 50px;" alt="logo" />
        </a>
      </template>
    </InfoCard>
    <InfoCard
    ...
    >
      ...
      <template #logo>
        <a href="https://www.fastretailing.com/eng/" target="_blank">
          <img src="src/images/fr.png" style="height: 50px;" alt="logo" />
        </a>
      </template>
    </InfoCard>
    <InfoCard
    ...
    >
      ...
      <template #logo>
        <a href="https://www.hr-force.co.jp/" target="_blank">
          <img src="src/images/hrforce.jpeg" style="height: 50px;" alt="logo" />
        </a>
      </template>
    </InfoCard>
  </div>
